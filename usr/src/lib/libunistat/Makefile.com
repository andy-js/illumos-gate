...
MODSTEMPLATES= \
	...
	spcs/spcs.tmpl \
	sdbc/sdbc.tmpl \
	solaris/solaris.tmpl \
	sv/sv.tmpl

ERRS=	$(MODSTEMPLATES:%.tmpl=$(SRCDIR)/%.err)
MSGS=	$(MODSTEMPLATES:%.tmpl=$(SRCDIR)/%.msg)
EDEFS=	$(MODSTEMPLATES:%.tmpl=$(SRCDIR)/%.edef)
TRNKS=	$(MODSTEMPLATES:%.tmpl=$(SRCDIR)/%.trnk)
DTRNKS=	$(MODSTEMPLATES:%.tmpl=$(SRCDIR)/%.dtrnk)
